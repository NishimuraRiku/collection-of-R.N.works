...
typedef enum
{
	UI_WARNINGTEXT_00_PARTS_WARNINGTEXT,	// 注意テキスト
...
{
	"data\\TEXTURE\\UserInterface\\ui_monster-mark_000.png",	// 通常
...
void UpdatePartsUi_warningText_00(VERTEX_2D *pVtx, UI_WARNINGTEXT_00_PARTS parts) 
{
	...
	switch (parts)
	{
	case /*/ 注意テキスト /*/UI_WARNINGTEXT_00_PARTS_WARNINGTEXT: {
