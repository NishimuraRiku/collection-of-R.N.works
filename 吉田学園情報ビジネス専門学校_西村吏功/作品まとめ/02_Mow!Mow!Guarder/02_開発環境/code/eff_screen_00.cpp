...
// グローバル宣言
//****************************************
LPDIRECT3DTEXTURE9		g_aTextureEff_screen_00 // テクスチャへのポインタ
						= NULL;
LPDIRECT3DVERTEXBUFFER9 g_pVtxBuffEff_screen_00	// 頂点バッファへのポインタ
						= NULL;
Eff_screen_00			g_eff_screen_00;		// EFF:スクリーン[00] の情報構造体
...
//========================================
// InitEff_screen_00関数 - EFF:スクリーン[00] の初期化処理 -
//========================================
void InitEff_screen_00(void)
{
	...
	// 頂点カラーの設定
	SetVertexColor2D(pVtx, g_eff_screen_00.col);
...
//========================================
// UninitEff_screen_00関数 - EFF:スクリーン[00] の終了処理 -
//========================================
...
//========================================
// UpdateEff_screen_00関数 - EFF:スクリーン[00] の更新処理 -
//========================================
void UpdateEff_screen_00(void)
{
	Eff_screen_00	*pEff	// EFF:スクリーン[00] の情報のポインタ
					= &g_eff_screen_00;
	...
	{// 透明度カウンターが0を上回っている時、
		...
		// 透明度を設定
		pEff->col.a = 255 * ((float)pEff->nCounterAlpha / (float)pEff->nCounterAlphaMax);
...
//========================================
// DrawEff_screen_00関数 - EFF:スクリーン[00] の描画処理 -
//========================================
...
//========================================
// SetEff_screen_00関数 - EFF:スクリーン[00] の設定処理 -
//========================================
