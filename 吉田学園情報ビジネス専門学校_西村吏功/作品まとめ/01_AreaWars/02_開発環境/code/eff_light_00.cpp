...
void UpdateEff_light_00(void)
{
	...
	for (int nCntEff_light_00 = 0; nCntEff_light_00 < EFF_LIGHT_00_MAX; nCntEff_light_00++, pVtx += 4)
	{
		...
		{// ライト[00]が使用されている時
			...
			{
				int nR = g_aEff_light_00[nCntEff_light_00].col.nR;	// 赤の強さ
				int nG = g_aEff_light_00[nCntEff_light_00].col.nG;	// 緑の強さ
				int nB = g_aEff_light_00[nCntEff_light_00].col.nB;	// 青の強さ
				int nA = g_aEff_light_00[nCntEff_light_00].col.nA;	// 透明度
