...
// 爆発[00] の最大数
#define ATK_EXPLOSION_00_MAX	(256)
...
// 爆発[00] のステータスを種類に応じて設定
void SetState(Atk_explosion_00 *pAtk);

//****************************************
// グローバル宣言
//****************************************
LPDIRECT3DTEXTURE9		g_aTextureAtk_explosion_00	//
						[ATK_EXPLOSION_00_TYPE_MAX] //
						= {};						// テクスチャへのポインタ
LPDIRECT3DVERTEXBUFFER9 g_pVtxBuffAtk_explosion_00	//
						= NULL;						// 頂点バッファへのポインタ
Atk_explosion_00		g_aAtk_explosion_00			//
						[ATK_EXPLOSION_00_MAX];		// 爆発[00] の情報
...
{//   テクスチャの相対パス                          , パターンの最大X, Y, アニメーションにかかる時間, 幅         , 高さ       , 当たり判定の半径, ダメージ, SE                           , パーティクルの種類           , パーティクルの発生数 , 振動の強さ, ストップ時間, 標的タイプ
	{ "data\\TEXTURE\\eff_explosion_002.png"		, 4              , 1, 4                         , PIXEL * 16 , PIXEL * 16 , PIXEL * 8       , 1       , SOUND_LABEL_SE_EXPLOSION_000 , EFF_PARTICLE_00_TYPE_SPARK_00, 10                   , 4.0f      , 0            , TARGET_TYPE_ENEMY_ONRY , true},
	{ "data\\TEXTURE\\eff_explosion_001.png"		, 4              , 2, 4                         , PIXEL * 32 , PIXEL * 32 , PIXEL * 16      , 2       , SOUND_LABEL_SE_EXPLOSION_000 , EFF_PARTICLE_00_TYPE_SPARK_00, 30                   , 4.0f      , 0            , TARGET_TYPE_ENEMY_ONRY , true},
	{ "data\\TEXTURE\\eff_explosion_000_medium.png" , 4              , 2, 4                         , PIXEL * 32 , PIXEL * 32 , PIXEL * 16      , 2       , SOUND_LABEL_SE_EXPLOSION_002 , EFF_PARTICLE_00_TYPE_SPARK_01, 40                   , 16.0f     , 40           , TARGET_TYPE_ENEMY_ONRY , true},
	{ "data\\TEXTURE\\eff_explosion_000_lange.png"	, 4              , 2, 4                         , PIXEL * 64 , PIXEL * 64 , PIXEL * 32      , 3       , SOUND_LABEL_SE_EXPLOSION_003 , EFF_PARTICLE_00_TYPE_SPARK_01, 50                   , 64.0f     , 80           , TARGET_TYPE_ENEMY_ONRY , true},
	{ "data\\TEXTURE\\eff_shot_break_001.png"	    , 4              , 1, 4                         , PIXEL * 16 , PIXEL * 16 , PIXEL * 0       , 0       , SOUND_LABEL_SE_EXPLOSION_004 , EFF_PARTICLE_00_TYPE_NONE    , 0                    , 0.0f      , 0            , TARGET_TYPE_ENEMY_ONRY , false},
	{ "data\\TEXTURE\\eff_explosion_002.png"	    , 4              , 1, 4                         , PIXEL * 16 , PIXEL * 16 , PIXEL * 0       , 100     , SOUND_LABEL_SE_EXPLOSION_000 , EFF_PARTICLE_00_TYPE_NONE    , 0                    , 0.0f      , 0            , TARGET_TYPE_ENEMY_ONRY , true},
	{ "data\\TEXTURE\\eff_explosion_001.png"		, 4              , 2, 4                         , PIXEL * 32 , PIXEL * 32 , PIXEL * 0       , 0       , SOUND_LABEL_SE_EXPLOSION_000 , EFF_PARTICLE_00_TYPE_SPARK_00, 30                   , 0.0f      , 0            , TARGET_TYPE_ENEMY_ONRY , true},
	{ "data\\TEXTURE\\eff_explosion_002.png"	    , 4              , 1, 4                         , PIXEL * 16 , PIXEL * 16 , PIXEL * 8       , 100     , SOUND_LABEL_SE_EXPLOSION_000 , EFF_PARTICLE_00_TYPE_SPARK_00, 10                   , 2.0f      , 0            , TARGET_TYPE_ENEMY_ONRY , false},
	{ "data\\TEXTURE\\eff_explosion_001.png"		, 4              , 2, 4                         , PIXEL * 32 , PIXEL * 32 , PIXEL * 16      , 2       , SOUND_LABEL_SE_EXPLOSION_000 , EFF_PARTICLE_00_TYPE_SPARK_00, 30                   , 4.0f      , 0            , TARGET_TYPE_ENEMY_ONRY , false},
};
...
void CollisionChr_enemy_00(Atk_explosion_00 *pAtk)
{
	...
	for (int nCntChr = 0; nCntChr < CHR_ENEMY_00_MAX; nCntChr++, pChr++)
	{
		...
		if (FindDistance(pAtk->pos, pChr->pos) < pAtk->fHitTestRadius + pChr->fHitTestWidth)
		{// 爆発[00] が敵[00] の当たり判定内に入った時、
			// 敵[00] のヒット処理
			pAtk->nCntChain += (HitChr_enemy_00ForAtk_explosion_00(pChr, pAtk->nDamage, pAtk->nCntChain) & (g_aAtk_explosion_00Type[pAtk->type].bChain));
		}
	}
}