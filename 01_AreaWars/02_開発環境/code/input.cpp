...
HRESULT InitInput(HINSTANCE hInstance, HWND hWnd)
{
	...
	// カーソル位置の保存内容を初期化
	g_CursorPosTemp = D3DXVECTOR3(0.0f, 0.0f, 0.0f);
